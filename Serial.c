...
/*	For ensuring the acknowledge command isn't received	*/
//volatile uint32_t transmitTime;
...
/* PORTE1 is TXD0, set as output pin
*  PORTE0 is RXD0, set as input pin
*/
...
ISR(USART2_RX_vect) 
{
	//if (transmitTime + 10 < get_tcnt0_ticks()){
